...
export const Services = () => {
    return (
        <div className="flex flex-wrap md:flex-no-wrap w-full mx-2">
            <div className="w-full md:w-1/3 md:p-6">
                <div className="text-gray-700 text-xl md:text-2xl">Always at service!</div>
                <h1 className="text-gray-900 text-4xl md:text-6xl leading-none font-semibold">
                    Creative ideas for developing business
                </h1>
            </div>
            <div className="w-full md:w-2/3 flex flex-wrap items-center justify-around">
                <ServiceCard
                    Icon={SolutionIcon}
...
export const ServiceCard = ({ Icon, title = "", desc = "" }) => {
    ...
    return (
        <div className="w-full md:w-1/2 px-2">
            ...
            <Icon className="fill-current w-12 h-12 text-teal-700 my-4" />
